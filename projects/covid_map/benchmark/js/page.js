 ...
 *
 */
const userAgent$1 = window.navigator.userAgent ;
const cache = {};
...
const operatingSystemVersions = {
  ...
  ios: function(){
    ...
    const match = userAgent$1.match(regex);
...
function isIos() {
  if (!cache.isIos) {
    cache.isIos = /iP(hone|od|ad)/.test(userAgent$1);
  }
  return cache.isIos;
}
...
function isIphone() {
  if (!cache.isIphone) {
    cache.isIphone = /iPhone/.test(userAgent$1);
  }
...
function isAndroid() {
  if (!cache.isAndroid) {
    cache.isAndroid = /Android/.test(userAgent$1);
  }
...
function isWebOS() {
  if (!cache.isWebOS) {
    cache.isWebOS = /webOS/.test(userAgent$1);
  }
...
function isBlackberry() {
  if (!cache.isBlackberry) {
    cache.isBlackberry = /Blackberry|BB10/.test(userAgent$1);
  }
...
function isWindowsMobile() {
  if (!cache.isWindowsMobile) {
    cache.isWindowsMobile = /IEMobile/.test(userAgent$1);
  }
...
//# sourceMappingURL=page.a2ced4e0.js.map
